...
pub fn line_hits_triangle(
    ...
    if !line_hits_plane(l1, l2, p1, p2, p3) { return false }
    if !line_hits_plane(p1, p2, l1, l2, p3) { return false }
    if !line_hits_plane(p2, p3, l1, l2, p1) { return false }
    if !line_hits_plane(p3, p1, l1, l2, p2) { return false }
    true
}
